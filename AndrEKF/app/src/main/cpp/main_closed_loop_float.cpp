...
std::string main1()
{
    ...
    // open data files
    pImuFile = open_with_exit ("/storage/C760-1A01/data/IMU.txt","r");
    pMagFile = open_with_exit ("/storage/C760-1A01/data/MAG.txt","r");
    pGpsFile = open_with_exit ("/storage/C760-1A01/data/GPS.txt","r");
    pAhrsFile = open_with_exit ("/storage/C760-1A01/data/ATT.txt","r");
    pAdsFile = open_with_exit ("/storage/C760-1A01/data/NTUN.txt","r");
    pTimeFile = open_with_exit ("/storage/C760-1A01/data/timing.txt","r");
    pGlitchOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/GlitchOffsetOut.txt","w");
    pStateOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/StateDataOut.txt","w");
    pEulOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/EulDataOut.txt","w");
    pCovOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/CovDataOut.txt","w");
    pRefPosVelOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/RefVelPosDataOut.txt","w");
    pVelPosFuseFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/VelPosFuse.txt","w");
    pMagFuseFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/MagFuse.txt","w");
    pTasFuseFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/TasFuse.txt","w");
    pRngFuseFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/RngFuse.txt","w");
    pOptFlowFuseFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/OptFlowFuse.txt","w");
    pGpsRawINFile = fopen ("/storage/C760-1A01/data/GPSraw.txt","r");
    pGpsRawOUTFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/GPSrawOut.txt","w");
    validationOutFile = fopen("/storage/emulated/0/Android/data/com.example.andrekf/files/ValidationOut.txt", "w");
    pOnboardFile = fopen ("/storage/C760-1A01/data/GPOSonboard.txt","r");
    pOnboardPosVelOutFile = open_with_exit ("/storage/emulated/0/Android/data/com.example.andrekf/files/OnboardVelPosDataOut.txt","w");

    pInFlowFile = fopen ("/storage/C760-1A01/data/FLOW.txt","r");
    pInDistFile = fopen ("/storage/C760-1A01/data/DIST.txt","r");
    pOutFlowFile = fopen ("/storage/emulated/0/Android/data/com.example.andrekf/files/FlowRawOut.txt","w");
